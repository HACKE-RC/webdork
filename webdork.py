  ...
  \ V  V /  __/ |_) | |_| | (_) | |  |   < 
   \_/\_/ \___|_.__/|____/ \___/|_|  |_|\_\
    ...
    def showresults(iterable_name) -> None:
        """
        Takes an iterable and prints all the items from it.
        """
...
parser.add_argument('-cn', "--company-name", type=str, metavar="Company name", help='Name of the company', required=True)
...
parser.add_argument("-o", metavar="Output", type=str, help="Output filename(default is dorkresults.txt).", default="dorkresults.txt")
...
if args.verbose and args.silent:
    print("[ ERR ] Verbose and Silent mode can\'t be turned on at the same time. [ ERR ]\nTry:\n\tRemoving the -v "
